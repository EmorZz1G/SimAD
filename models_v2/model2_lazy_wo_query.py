...
class Attention(nn.Module):
    ...
    def __init__(self, d_model, n_head, max_len = 2000, seq_len=0, mask=False, dropout=0.) -> None:
        super().__init__()
...
class ContAD_wo_ci(nn.Module):
    ...
    def __init__(self, c_dim, seq_len=2048, patch_size=16, d_model=256, n_layers=3, d_feed_foward_scale=4, n_head=4, dropout=0.0, with_inter=1,with_intra=1, proj_dim=10) -> None:
        super().__init__()
        ...
        self.encoder = Encoder(
            [
                EncoderLayer( 
                    Attention(d_model, n_head, mask=False, dropout=dropout, seq_len=seq_len//patch_size),
                    d_model,
                    d_feed_foward,
                    dropout=dropout
